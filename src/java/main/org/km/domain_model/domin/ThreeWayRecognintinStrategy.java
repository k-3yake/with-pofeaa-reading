...
public class ThreeWayRecognintinStrategy extends RecognitionsStrategy {
	private int firstRecognitionOffset;
	private int secondRecognitionOffset;

	public ThreeWayRecognintinStrategy(int firstRecognitionOffset,int secondRecognitionOffset) {
